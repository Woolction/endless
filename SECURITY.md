...
1. **GitHub Security Advisories (Recommended):**
   Go to the "Security" tab => "Advisories" in our repository and click "Report a vulnerability". This is the most secure way to contact the maintainers.
...
2. Assess the severity of the vulnerability and provide you with an initial verdict.
